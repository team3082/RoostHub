...
export default function Header() {
    const {deleteAllData} = useDatabaseStore();
        ...
        <div className="relative z-20 bg-[#F7F7F7] border-b border-[#E9E9E9] px-6 py-4 shadow-sm">
            <div className="flex items-center justify-between w-full">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        onClick={() => {
                            const confirmed = window.confirm('Delete ALL local data? This action cannot be undone. Are you sure you want to proceed?');
                            if (confirmed) {
                                deleteAllData();
                            }
                        }}
